...
#        ? version == $n {
#            p_g = p * 4.1
#            kcal = p * 4.1 * 0.4 + c * 4.1 * 0.2 + f * 9.3 * 0.4;
#            p =>
#            kcal = p * 4.1 * 0.4 + c * 4.1 * 0.2 + f * 9.3 * 0.4;
#            => 
#            kcal = p * 4.1 * 0.4 + x * 0.5 * 4.1 * 0.2 + x * 0.5 * 9.3 * 0.4;
#            =>
#            kcal = p * 4.1 * 0.4 + x * (0.5 * 4.1 * 0.2 + 0.5 * 9.3 * 0.4);
#            x = kcal - (p * 4.1 * 0.6)
#            =>
#            kcal = p * 4.1 * 0.4 + (kcal - (p * 4.1 * 0.6)) * (0.5 * 4.1 * 0.2 + 0.5 * 9.3 * 0.4);
#            =>
#            y = (0.5 * 4.1 * 0.2 + 0.5 * 9.3 * 0.4)
#            kcal = p * 4.1 * 0.4 + kcal * y - p * 4.1 * 0.6 * y;
#            =>
#            0 = p * 4.1 * 0.4 + kcal * y - p * 4.1 * 0.6 * y - kcal;
#            =>
#            0 = p * 4.1 * 0.4 + kcal * y - kcal - p * 4.1 * 0.6 * y;
#            =>
#            0 = p * 4.1 * 0.4 + kcal * (y - 1) - p * 4.1 * 0.6 * y;
#            => 
#            0 = p * (4.1 * 0.4 - 4.1 * 0.6 * y) + kcal * (y - 1);
#            =>
#            p * (4.1 * 0.4 - 4.1 * 0.6 * y) = kcal * (1 - y);
#            =>
#            p  = (kcal * (1 - y)) / (4.1 * 0.4 - 4.1 * 0.6 * y);
#            =>
#            p  = kcal * ( 1 * (4.1 * 0.4 - 4.1 * 0.6 * y)
#                        - y * (4.1 * 0.4 - 4.1 * 0.6 * y));
